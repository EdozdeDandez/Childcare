...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void postDataToSQLite() {
        ...
        if (!inputValidation.isInputEditTextFilled(editTextAddress, getString(R.string.error_message_name))) {
            return;
        }
        if (!inputValidation.isInputEditTextFilled(editTextPhone, getString(R.string.error_message_name))) {
            return;
        }
        if (!inputValidation.isInputEditTextFilled(editTextDob, getString(R.string.error_message_name))) {
            return;
        }
